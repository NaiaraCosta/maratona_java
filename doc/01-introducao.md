...
O desenvolvedor escreve o código em um arquivo .java
O compilador (javac) converte o código em bytecode, gerando um arquivo .class
A JVM lê esse bytecode e o converte em código nativo usando o compilador JIT (Just-In-Time)
